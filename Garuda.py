...
GARUDA_banner = f"""
GARUDA is a powerful integration tool{yellow}
...
|       |  |   / .. \  |     /   |        |  |     .    /  .. \   {blue}
---------  |  /      \ |     \   |........   |.....    /       \  {white}git.io/fjHT1
{red}GARUDA is under development, please update before each use!{end}
"""


class Garuda (object):
    """
    Garuda help summary page
    ...
    Example:
        ...
        python3 garuda.py --target example.com --brute False run
