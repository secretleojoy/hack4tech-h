...
class Module(object):
    def __init__(self):
        ...
        self.header = dict()
        self.proxy = None
        self.delay = 1  # Request sleep delay
        self.timeout = settings.request_timeout_second  # Request timeout
        self.verify = settings.request_ssl_verify  # Request SSL verification
        self.domain = str()  # The main domain that is currently collecting subdomains
        self.subdomains = set()  # Store discovered subdomains
        self.infos = dict()  # Store information about subdomains
        self.results = list()  # Store module results
        self.start = time.time()  # Module start time
        self.end = None  # Module end execution time
        self.elapse = None  # Module execution time-consuming
